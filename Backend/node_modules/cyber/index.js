...
if (firstArgs == 'start') {
	...
	console.log('\nWelcome to use '+ color.magenta('ce-server') + ' ' + package.version);

	console.log('Examples:');
	console.log('    ce-server init');
	console.log('    ce-server start');
	console.log('    ce-server start --port 3000');
	console.log('');
	console.log('For more info, Join us => Aliwangwang Group: 1421163385');
	console.log('');
